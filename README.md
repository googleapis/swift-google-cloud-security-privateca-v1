# Google Cloud Client Libraries for Swift - Certificate Authority API
...
Add `swift-google-cloud-security-privateca-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-security-privateca-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudSecurityPrivateCAV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudSecurityPrivateCAV1 <target-name> --package swift-google-cloud-security-privateca-v1
```
