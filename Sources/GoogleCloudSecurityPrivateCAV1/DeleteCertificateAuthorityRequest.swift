...
///
/// [google.cloud.security.privateca.v1.CertificateAuthorityService.DeleteCertificateAuthority]: <doc:CertificateAuthorityServiceClient/deleteCertificateAuthority(request:)>
